...
class BaseSuGaRSystem(BaseLift3DSystem):
    ...
    def on_predict_start(self) -> None:
        ...
        # idx_textures_uv = rc.surface_mesh.textures.m
        self.verts_uv = rc.verts_uv
        self.faces_uv = rc.faces_uv
        
        self.idx_mesh = Meshes(
            verts=[rc.surface_mesh.verts_list()[0]],
            faces=[rc.surface_mesh.faces_list()[0]],
            textures=rc.surface_mesh.textures,
        )
        self.surface_mesh = self.geometry.surface_mesh_torch3d
